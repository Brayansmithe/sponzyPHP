    ...
    <div class="row mt-3 justify-content-center align-item-center">
        <div class="card carddim p-2">
            <div class="card-body">
              ...
              <div class="liste ">
                <a href="home.php" class="lienliste text-center">liste des personnes parainer</a>
              </div>
              <div class="copie1 copie1s text-center d-flex mt-5 border large-80 pe-4 ps-4 justify-content-between align-items-center rounded ps-3">
                <div class="code text-center">
                    <h5 class=" text-white text-center">code: <?php if (isset($cle)) {  echo $cle; }; ?></h5>
                </div>
                <!-- <div class="copie ">
              ...
              <div class="copie1 text-center copie1s d-flex mt-5 border large-80 pe-4 ps-4 justify-content-between align-items-center rounded ps-3">
                <div class="code text-center">
