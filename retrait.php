                    ...
                    <div class="d-flex justify-content-center card-body">
                        ...
                        <div class="">
                            ...
                            <div class=" formaction mb-5 ">
                                <h3 class="mb-5 pags2">Votre Moyen de retrait Ajouter: Montant Minimum 4500 FCFA</h3>
                                <div class="d-flex justify-content-between mb-3">
                                    <p class="pags1">Prénom: </p>
                                    <p class="texte1 "> 
                                        <?php 
                                            /* $req = $con->prepare("SELECT * FROM utilisateurs where num_tel=");
                                            $req->execute();
                            ...
                            <div class="mt-5">
                                <form action="moyenRetrait.php" class="form-data formaction mb-5 mt-5">
